...
5. Figure out proper title and description for a GitLab Merge Request: title must be concise and meaningful, description must still be concise but also comprehensive and structured. Use GitLab-flavored markdown to the purpose. Include reference to issue "$1" (if any) at the very beginning of description.
